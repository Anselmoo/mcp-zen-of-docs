---
hook_target: 'pre-init-validate'
---

# Copilot Extension Hook

- **Hook target:** `pre-init-validate`
- **Required baseline artifact:** `false`
- **Design summary:** Forward-compatible pre-init hook contract for future team packs.
